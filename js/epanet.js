	...
	svg.render = function() {
		...
		if (model[s]) {
			...
			var l = model[s][link],
				...
				v = epanetjs.results[step]['LINKS'][link.replace("#",'')][linkResult],
			...
			if (c1 && c2) {
				...
				el.append('line')
					...
					.attr('to',node2)
					.attr('id',"line_"+link)
					.attr('onclick','drow_chart_Link(this)')
					.attr('stroke-width', strokeWidth);
				...
				el.append('circle')
					...
					.attr('id', link)
					.attr('onclick','drow_chart_pump(this)');
				el.append('rect')
		...
		if (model.RESERVOIRS[coordinate]) {
		    el.append('rect')
			    ...
			    .attr('onclick', 'drow_chart_RESERVOIRS(this)')
			    .attr('fill', color);
		    ...
		    el.append('polygon')
			    ...
			    .attr('onmouseover', 'epanetjs.svg.tooltip(evt.target)')
			    .attr('onmouseout', 'epanetjs.svg.clearTooltips(evt.target)')
			    .attr('onclick', 'drow_chart_TANKS(this)')
			    .attr('fill', color);
		} else {
			if(coordinate!="TN387" && coordinate !="TN389" && coordinate!="TN391" && coordinate !="TN379" && coordinate!="TN381" && coordinate!="TN383"
				&& coordinate!="TN459" && coordinate!="TN458" && coordinate!="TN460" && coordinate!="TN403"
				&& coordinate!="TN405" && coordinate!="TN409" && coordinate!="TN395" && coordinate!="TN397"
				&& coordinate!="TN399" && coordinate!="TN401" && coordinate!="TN385" && coordinate!="TN199"
				&& coordinate!="TN407" && coordinate!="TN197" && coordinate!="TN182" && coordinate!="TN407" 
				&& coordinate!="TN407" && coordinate!="TN407" && coordinate!="TN407" && coordinate!="TN407"  
				)
			{
				  el.append('circle')
			    .attr('cx', c.x)
			    ...
			    .attr('onmouseover', 'epanetjs.svg.tooltip(evt.target)')
			    .attr('onmouseout', 'epanetjs.svg.clearTooltips(evt.target)')
			    .attr('onclick', 'drow_chart_JUNCTIONS(this)')
			    .attr('id', 'circle_'+coordinate)
			    .attr('fill', color);
			}
